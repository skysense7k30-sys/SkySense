  ...
  return (
    <>
      ...
      <style>{`
        ...
        .arc2-heading em { color: #c6f135; font-style: normal; }
        ...
        .arc2-card.arc2-0::after { background: #c6f135; }
        .arc2-card.arc2-1::after { background: #7b6cff; }
        .arc2-card.arc2-2::after { background: #ff6b35; }
        ...
        .arc2-comp.has-model:hover .arc2-comp-cube { color: #c6f135; transform: rotate(15deg); }
      ...
      <section className="arc2-section" ref={ref}>
