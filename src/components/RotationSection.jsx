  ...
  return (
    <>
      <style>{`
        ...
        .rot-heading em { color: #c6f135; font-style: normal; }
        .rot-body { display: grid; grid-template-columns: 1fr 1fr; gap: clamp(2rem, 5vw, 5rem); align-items: center; }
        .rot-canvas-wrap { aspect-ratio: 1; max-width: 420px; margin: 0 auto; position: relative; background: radial-gradient(ellipse at center, rgba(123,108,255,0.06) 0%, transparent 70%); }
        ...
        .rot-rules li::before { content: "›"; position: absolute; left: 0; color: #c6f135; }
          ...
          <div>
            <div className="rot-legend">
              <div className="rot-legend-item">
                <div className="rot-legend-dot" style={{ background: "#c6f135" }} />CCW (FL + RR)
              </div>
              <div className="rot-legend-item">
                <div className="rot-legend-dot" style={{ background: "#7b6cff" }} />CW (FR + RL)
              </div>
            </div>
