  ...
  return (
    <>
      <style>{`
        ...
        .flow-heading em { color: #1e3a8a; font-style: normal; }
        ...
        .flow-node-inner:hover { border-color: rgba(59,91,219,0.4); background: #111122; }
        ...
        .flow-line { height: 1px; width: 28px; background: linear-gradient(90deg, #3b5bdb, rgba(59,91,219,0.2)); }
        .flow-chevron { color: #3b5bdb; font-size: 14px; line-height: 1; }
        .flow-node:first-child .flow-node-inner::before { content: ""; position: absolute; top: 0; left: 0; bottom: 0; width: 3px; background: #3b5bdb; }
        .flow-node:last-child .flow-node-inner::after { content: ""; position: absolute; top: 0; right: 0; bottom: 0; width: 3px; background: #1e3a8a; }
      `}</style>
